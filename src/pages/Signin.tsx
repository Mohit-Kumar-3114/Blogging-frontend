        ...
        <div className="flex-1 flex justify-center items-center bg-gradient-to-br from-indigo-950 to-purple-900 w-full lg:w-1/2 px-4 sm:px-6 lg:px-8 py-8 lg:py-0">
          <div className="max-w-md p-4 sm:p-6 lg:p-8">
            ...
            <div className="flex space-x-3 sm:space-x-4 mb-4">
              <a href="https://github.com/Mohit-Kumar-3114" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-white transition-colors duration-200">
              ...
              <a href="https://www.linkedin.com/in/mohit-kumar-79866a264/" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-white transition-colors duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                </svg>
              </a>
              <a href="mailto:mohitahlawat912@gmail.com" className="text-slate-300 hover:text-white transition-colors duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="currentColor">
