          ...
          <div className="text-white">
            ...
            <div className="text-slate-300 font-serif space-y-2">
              <p className="flex items-center">
                ...
                <a href="mailto:mohitahlawat912@gmail.com" className="hover:text-indigo-300 transition-colors duration-200">
              ...
              <p className="flex items-center">
                ...
                <a href="https://github.com/Mohit-Kumar-3114" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-300 transition-colors duration-200">
              ...
              <p className="flex items-center">
                ...
                <a href="https://www.linkedin.com/in/mohit-kumar-79866a264/" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-300 transition-colors duration-200">
